...
import { connect, MapStateToProps, MapDispatchToProps, MapDispatchToPropsFunction } from 'react-redux';
...
class Team2 extends React.Component<Team2StateProps & Team2DispatchProps & Team2OwnProps, Team2State> {
    ...
    constructor(props: Team2StateProps & Team2DispatchProps & Team2OwnProps) {
        super(props);
    }
...
const mapStateToProps: MapStateToProps<Team2StateProps, Team2OwnProps, Team2State> = (state: any) => {
    return {
