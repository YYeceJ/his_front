...
var BASE_URL = minimist(process.argv.slice(2)).BASE_URL ? minimist(process.argv.slice(2)).BASE_URL : '/www/';
...
var basePlugins = [
    ...
    new CopyWebpackPlugin([{ from: './src/mock', to: 'mock' }]),
        ...
        rules: [
            ...
            { enforce: "pre", test: /\.js$/, loader: "source-map-loader" },
            {
                ...
                use: isTest ? 'null' : [
                    ...
                    'cache-loader', 'css-loader?sourceMap'
                ]
            },
            {
                // ASSET LOADER
